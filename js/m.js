document.addEventListener("DOMContentLoaded", () => {
    ...
    const userData = {
        ...
        "age": 20,
        "profession": "Student",
        "location": { "city": "Chattogram", "country": "Bangladesh" },
        "interests": ["Tech", "Programming", "Gaming", "Coding"],
        "contact": { "telegram": "@mdfarukofficial22", "email": "mdomarfarukfaysal12@gmail.com" }
    };
    if (jsonContainer) {
